...
class City{
    ...
    public function get_city_sync($last_updated){
        ...
        $text = "SELECT id_kabupaten, id_provinsi, kode_kabupaten, nama_kabupaten, keterangan, 
            status, timestamp FROM $this->table WHERE status = 1 $cond ORDER BY nama_kabupaten ASC";
